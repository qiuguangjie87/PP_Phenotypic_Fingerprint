...
def LWGANet_L2_1442_e96_k11_ReLU(num_classes: int = 1000, embed_dim=96, dropout=0.1,fork_feat=True, **kwargs):
...
def LWGANet_L1_1242_e64_k11_ReLU(num_classes: int = 1000, embed_dim=64, dropout=0.1,fork_feat=True, **kwargs):
    model = LWGANet(in_chans=3,
                    num_classes=num_classes,
                    stem_dim=embed_dim,
                    depths=(1, 2, 4, 2),
...
def LWGANet_L0_1242_e32_k11_ReLU(num_classes: int = 1000, embed_dim=32, dropout=0.0,fork_feat=True, **kwargs):
    model = LWGANet(in_chans=3,
                    num_classes=num_classes,
                    stem_dim=embed_dim,
                    depths=(1, 2, 4, 2),
...
if __name__ == '__main__':
    ...
    net = LWGANet_L0_1242_e32_k11_ReLU()
    print(net)
    features = net(x)
    for i, feature in enumerate(features):
        print(f"Stage {i + 1} feature shape: {feature.shape}")